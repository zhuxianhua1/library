              ...
              <tr>
                <td width="2%">&nbsp;</td>
                  <td width="97%" align="center" valign="top">
                    <form name="form1" action="index.do" method="post">
                      ...
                      <td width="31%">
                        <input name="name" type="text" class="logininput" id="name" size="27" > <p>${errorName}</p>               </td>
                      <td width="9%">&nbsp;</td>
                    </tr>
                        <tr>
                          <td height="37">&nbsp;</td>
                      <td>管理员密码：</td>
                      <td><input name="pwd" type="password" class="logininput" id="pwd" size="27"><span>${errorPassword} </span></td>
                      <td>&nbsp;</td>
                    </tr>
                        <tr>
                          <td height="30">&nbsp;</td>
